...
public class SoundManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PlateKitchenObject.OnAnyObjectPlacedHere += PlateKitchenObject_OnAnyObjectPlacedHere;
    }

    private void PlateKitchenObject_OnAnyObjectPlacedHere(object sender, EventArgs e)
    {
